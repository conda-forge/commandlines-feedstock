...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/commandlines-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13743&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/commandlines-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `commandlines` can be installed with:

```
conda install commandlines
```

It is possible to list all of the versions of `commandlines` available on your platform with:
